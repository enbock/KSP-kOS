...
declare function GYROINIT{
    ...
    set landingtargetLATLNG to SHIP:GEOPOSITION.
    ...
    lock totalSpeed to GROUNDSPEED + ABS(VERTICALSPEED).
...
declare function PRINTTOSCREEN{
    ...
    print "VerticalSpd: " + round(VERTICALSPEED, 1) + "          " at (5,screenline).
         set screenline to screenline + 1.
    print "Surface Spd: " + round(GROUNDSPEED, 1) + "          " at (5,screenline).
         set screenline to screenline + 1.
         set screenline to screenline + 1.
    ...
    print "Fall Time:    " + round(fallTime, 2) + "       " at (5,screenline).
         set screenline to screenline + 1.
    print "HorizontalTtL:" + round((gs_distance(shipLatLng,landingtargetLATLNG) / GROUNDSPEED), 2) + "       " at (5,screenline).
         set screenline to screenline + 1.
